...
export default function SundialAuthFeaturesGrid ({}) {
    ...
    <span>
        ...
        {" "}
        makes it easy to figure out what you have to do and when it's important to focus on a new task. Goodbye, todo list.
    </span>
    ...
    <span>
        ...
        {" "}
        works anywhere. Put your priorities somewhere special and work on the go.
    </span>
            ...
            },
            {
                ...
                "body":
    <span>
        Still choosing the best app?
        {" "}
        <span className={classes.brand}>
            Sundial
        </span>
        {" "}
        is free to use, forever. You can even learn how it works on Github and request new features.
    </span>
    ...
    return (
        <div className={classes.root}>
            <div className={classes.grid}>
                ...
                { features.map((f, i) => <SundialAuthFeatureCard
                        feature={f}
                        key={i}
                    />) }
