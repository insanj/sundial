...
export default function SundialAuthPage ({networker, onGoogleSuccess}) {
    ...
    const classes = useStyles(),
        sundialGoogleButtonId = "SundialGoogleButton",

        sundialSVG =
            (<svg
className={classes.sundialSVG}
           fill="#fff"
        ...
        <div className={classes.root}>
            <div className={classes.container}>
                ...
                <div className={classes.connect}>
                    <div id={sundialGoogleButtonId} />

                    <div className={classes.connectHelper}>
                        Use Sundial by signing into your Google account.
                        <br />
                        By clicking, you agree to the use of
